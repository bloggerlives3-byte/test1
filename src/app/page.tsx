...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8f4f1] via-[#f3f7f8] to-[#ecf1ff] text-slate-900">
      <main className="mx-auto flex max-w-6xl flex-col gap-8 px-5 py-12 sm:px-10 lg:px-12">
        <header className="flex flex-col gap-4 rounded-3xl bg-white/80 p-6 shadow-xl ring-1 ring-black/5 backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-slate-600">
            <div className="flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-2 font-medium text-emerald-700 shadow-inner">
              <span className="inline-block h-2 w-2 rounded-full bg-emerald-500" />
              Live privacy mode
            </div>
            <div className="rounded-full bg-slate-100 px-3 py-2 font-medium text-slate-700 shadow-inner">
